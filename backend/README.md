...
## Project Structure
    ...
    ├── solitary_wildflower_90283  # Django project configurations
...
1. Clone this repo and `cd solitary_wildflower_90283`
...
2. Clone this repo and `cd solitary_wildflower_90283`
